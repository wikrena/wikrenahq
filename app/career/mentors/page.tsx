...
export const metadata: Metadata = { title: "Mentors — Wikrena Academy" }
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto text-center py-16 px-4">
        ...
        <h1 className="font-display font-black text-2xl text-navy-800 mb-3">Mentors</h1>
        <p className="text-neutral-500 text-sm mb-8 leading-relaxed max-w-md mx-auto">Connect with senior data professionals who have placed at MTN, Paystack, Flutterwave and more.</p>
