...
export const metadata: Metadata = { title: "Mock Interviews — Wikrena Academy" }
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto text-center py-16 px-4">
        ...
        <h1 className="font-display font-black text-2xl text-navy-800 mb-3">Mock Interviews</h1>
        <p className="text-neutral-500 text-sm mb-8 leading-relaxed max-w-md mx-auto">Practice answering data interview questions with Wren AI. Get scored and coached.</p>
