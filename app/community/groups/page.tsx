...
import { StudyGroupsPage } from "@/components/academy/study-groups"

export const metadata: Metadata = { title: "Study Groups — Wikrena Community" }

export default async function StudyGroupsRoute() {
